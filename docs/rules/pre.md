...
1. 본원의 학부생을 위하는 온라인 정보통신 서비스
2. 본회 서버 자원 운영, 대여 및 관리 서비스
3. 정보통신 관련 세미나 및 대회
4. 기타 본회의 목적을 수행하기 위한 사업
...
2. 본회의 회원은 개발자 프로그램 또는 디자이너 프로그램을 이수한 후 활동회원 과반 이상이 참석한 총회에서 참석한 활동회원 3분의 2 이상의 찬성으로 해당 자격을 획득할 수 있다.

### 제7조 (활동 회원)

1. 정회원은 매 봄학기와 가을학기마다 활동회원 또는 비활동회원에 속한다.
2. 정회원이 재학 중 정당한 사유로 본회 활동에 참여할 수 없을 것이라 판단되는 경우 이사회에 비활동 신청 기간 동안 비활동 신청을 할 수 있다. 단, 해당 학기를 휴학한 경우 봄 정기총회 또는 가을 정기총회 전까지 이사회에게 비활동 신청을 할 수 있다.
...
6. 활동 회원은 비활동 신청 기간 안에 개발자, 혹은 디자이너 두 역할 중 한 가지 이상을 선택하여 활동하여야 한다. 단, 선택한 역할에 대한 자격이 있어야 한다.
...
2. 준회원은 해당 학기 동안 아래의 의무 사항을 이행해야 하며, 이행하지 못할 시 개발자 또는 디자이너 자격심사에 참여하지 못하며 제12조에 따라 제명안에 상정된다.

가. 이사회에서 정한 회비 납부

나. 제37조, 제38조에 따라 이사회가 정한 개발자 또는 디자이너 프로그램 이수

다. 이사회가 정한 정기총회, 행사 및 정기 모임 참석 횟수 달성
...
1. 매 학기 이사회는 이사회를 포함하는 신입 회원 선발 위원회를 구성해야 한다. 위원회는 이사회가 선발한다. 위원회의 임기는 신입 회원 선발 완료 시점까지이다.
2. 신입 회원 선발 위원회에서는 신입 회원 선발 절차와 규모를 결정한다.
3. 신입 회원 선발은 개강 후 3주 이내에 신입 회원 선발 위원회에서 정한 절차를 따른다.
4. 이사회는 임시총회에서 신입 회원 추가 모집에 대한 안건을 상정할 수 있다.

### 제12조 (회원의 탈퇴 및 징계)

1. 회원은 본인의 의사에 따라 자유롭게 탈퇴할 수 있다.
2. 활동회원이 제9조에 따른 의무를 이행하지 못할 시 총회에서 해당 활동회원에 대한 제명안을 상정한다.
3. 이사회가 자격 미달이라고 판단한 회원은 이사회에서 적절한 근거를 제시하여 총회에서 제명안을 상정할 수 있다.
...
1. 회장, 이사, 감사는 제29조에서 정하는 가을 정기총회에서 선출한다.
2. 회장 및 이사 후보로 선출될 수 있는 자는 회장 임기 동안 학부에 재학 예정이며 성실히 활동할 수 있는 정회원이어야 한다.
3. 임원 후보의 선출은 자진 선출과 활동회원의 추천을 우선한다. 이 때 후보가 없을 경우 이사회에서 임원 후보를 지명한다.
4. 각 직위별 이사를 각 호와 같이 추천 또는 지명할 수 있다.
...
2. 탄핵은 임시총회에서 활동회원 ¼ 이상의 발의가 있어야 하며, 그 안건은 탄핵 발의를 받은 자를 제외하여 의결한다.
...
4. 회장을 제외한 이사는 다음 각 호에 해당하는 직위를 총회 또는 이사회 결의를 통해 맡을 수 있다.
...
③ 임시총회는 회장 또는 감사 및 회원 1/4 이상의 서면 요청이 있을 때 소집한다.
...
3. 모든 의결은 익명으로 표를 행사하나, 이사회의 판단으로 실명 투표를 진행할 수 있다. 단, 다음 각 호의 의결은 언급되고 있는 각 조항에 따른다.
...
3. 기존 서비스의 새 PM는 해당 서비스의 전 PM이 임명을 요청하여 이사회가 허가한다.
4. 새 서비스 또는 PM이 부재중인 서비스의 경우 PM과 이사회가 해당 서비스의 PM을 임명한다.
...
5. PM은 희망하는 자 중 이사회가 지명한 자로 한다. 단, 희망자가 없을 경우 이사회는 프로젝트 구성원 중 한 명을 지목하거나 프로젝트를 해산할 수 있다.
...
2. 1항의 협력에 대하여 회장 및 부회장은 대표권을 가지며, 이사회는 관리 및 감독의 의무가 있다.
3. 1항의 협력이 예산 집행 및 편성, 기기의 사용성 등 본 회 운영에 현저한 영향을 주지 않는 경우 PM의 판단 하에 본 조 1항 및 2항의 의무와 권리를 대행할 수 있다. 단, 이 경우 이사회에 지속적인 보고의 의무를 진다.
...
1. 본 회칙 이전에 선출된 회장, 부회장, 총무, Wheel장 및 디자인 팀장은 별도의 이사회 결의 없이 자동으로 기존의 직위를 가지는 이사로 선임하여 직무를 수행한다.
2. 본조 1항에 해당하는 이사의 임기는 본 회칙에 의해 후임자가 선임되는 전일까지로 한다.
