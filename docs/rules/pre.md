...
2. 본회의 회원은 개발자 프로그램 또는 디자이너 프로그램을 이수한 후 총회에서 참석한 활동회원 3분의 2 이상의 찬성을 통한 의결로 해당 자격을 획득할 수 있다.
...
6. 활동회원은 비활동 신청 기간 안에 개발자, 혹은 디자이너 두 역할 중 한 가지 이상을 선택하여 활동하여야 한다. 단, 선택한 역할에 대한 자격이 있어야 한다.
