...
2. 불가피한 사유가 존재할 경우 이사회의 결정에 따라 주사무소를 본조 1항의 위치 외에 국내의 다른 지역에 둘 수 있다.
...
나. 제20조, 제21조에 따라 이사회가 정한 개발자 또는 디자이너 프로그램 이수
...
1. 매 학기 개강 전 이사회는 이사회를 포함하는 신입 회원 선발 위원회를 구성해야 한다. 위원회는 이사회가 선발한다. 위원회의 임기는 신입 회원 선발 완료 시점까지이다.
...
2. 활동회원이 제7조에 따른 의무를 이행하지 못할 시 총회에서 해당 활동회원에 대한 제명안을 상정한다.
3. 이사회가 자격 미달이라고 판단한 회원은 이사회에서 적절한 근거를 제시하여 총회에서 제명안을 상정할 수 있다.
4. 제명안이 상정된 회원이 해당 학기 이전에 경고를 받은 적이 없고 총회에서 본회 활동을 지속할 것을 표명한 경우 소명 후 본인을 제외한 총회에 참석한 활동회원의 ⅔ 이상이 동의한 경우에 한해 경고로 대체할 수 있다. 그 이외의 경우 제명된다.
...
5. 회장 후보의 선출은 자진 선출과 활동회원의 추천을 우선한다. 이 때 후보가 없을 경우 이사회에서 회장 후보를 지명한다.
...
4. 회장을 제외한 이사는 다음 각 호에 해당하는 직위를 이사회 결의를 통해 맡을 수 있다.
...
2. 총회에서 안건의 의결은 모든 참석한 활동회원이 찬성, 반대, 기권 중 하나를 선택함으로써 이루어진다. 의결이 유효하기 위해서는 총회에 활동회원 과반수가 참석해야한다. 참석한 활동회원의 과반수가 찬성할 시 가결된다. 또한, 모든 의결은 익명으로 표를 행사하나, 이사회의 판단으로 실명 투표를 진행할 수 있다. 단, 다음 네 안건의 의결은 언급되고 있는 각 조항에 따른다.
...
1. 매년 봄학기 종강일 2주 전에서 종강일 사이에 정기총회를 한다. 단, 휴일 등의 불가피한 사유로 인하여 이사회의 결정에 따라 연기 혹은 조기에 시행할 수 있다.
...
1. 매년 가을학기 종강일 2주 전에서 종강일 사이에 정기총회를 한다. 단, 휴일 등의 불가피한 사유로 인하여 이사회의 결정에 따라 연기 혹은 조기에 시행할 수 있다.
...
1. 임시총회는 이사회 또는 활동회원 4분의 1 이상의 발의에 의해 소집된다.
