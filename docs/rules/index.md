...
2. 국내외 컴퓨터 시스템 발전 및 학술적 교류에 이바하는 서비스 및 대회
3. 본회 서버 자원 운, 대여 및 관리 서비스
4. 정보통신 관련 세미나 및 대회
...
4. 이사회가 비활동 신청을 한 회원의 사유가 정당하다고 판단하 다음 봄학기 또는 가을학기 개강일 전까지 해당 회원은 비활동회원이다.
...
3. 회원이 다음 각호의 사유에 해당 경우에는 이사회에서 총회에 제명안을 상정할 수 있다.  
...
3. 감사는 일반회계 및 운영에 대해 감사하며 부정 또는 부당한 점이 있으 이사회에 시정을 요구하고 그 보고를 위하여 이사회 또는 총회의 소집을 요구할 수 있다.
...
1. 회장은 본회를 대표하며, 총회 이사회의 의장이 된다. 정기모임에서 사회자가 되거나 부회장을 사회자로 선임할 수 있다.
2. 회장은 본회의 대외활동에서 대표권을 가진다.
3. 회장은 임시총회 이사회를 소집, 주관할 수 있다.
...
3. 총무는 정기모임, 워크 등 회원 전체가 참여하는 활동을 회원들에게 공지하는 것을 담당한다.
...
1. 이사회는 정기이사회 임시이사회로 구분하며 회장이 소집한다.
...
이사회 총회의 의사 진행 경과와 결과는 회의록으로 작성해야 하며 의장과 참여 이사가 기명 날인한다.
...
6. PM은 프로젝트 운영에 있어서 중대한 사항 및 이사회가 요청한 사항을 바 이사회에 보고해야 한다.
...
4. 이사회는 외부 협력의 지속적인 증진을 위해서 1항의 협력에 관여하는 회원에게 성과급이나 특을 줄 수 있다.
...
4. 예산 집행 시 모 전표에 대해 영수증을 첨부하여야 한다.
...
2. 단, 회칙 개정의 경우에는 이사회가 긴급한 상황이라 판단하는 경우 서면 의결을 진행할 수 있으며, 서면 의결을 통해 의사를 표현한 회원은 물리적으로 총회 장소에 있지 않더라도 참석한 것으로 간주하여 참석 인원에 포함한다.
...
1. 디자인 피드백은 디자이너가 독단적으로 작업하지 않으며, 타 디자이너들과의 협의를 통해 실제 출될 프로젝트의 디자인 완성도를 끌어올리고 디자이너의 작업 부담을 줄이는 것을 목적으로 한다.
...
2. 디자인 팀장의 임기는 그를 임명한 총회의 다음 로부터 차기 디자인 팀장을 임명하는 총회 당일까지의 1년이다.
3. 정기총회에서 디자이너의 자격을 가지는 1인을 전임 디자인 팀장이 결정한다. 단, 전체 디자인 팀 구성원 절반 이상의 동의를 얻어야 한다.
4. 디자인 팀장은 디자이너의 참여가 필요한 프로젝트를 판단하여 지정한다. 지정된 프로젝트는 출 이전에 최소 한 번 이상 디자이너를 포함해야 한다.
