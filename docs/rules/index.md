...
2. 국내외 컴퓨터 시스템 발전 및 학술적 교류에 이바지하는 서비스 및 대회
3. 본회 서버 자원 영영, 대여 및 관리 서비스
4. 정보통신 관련 세미나 및 대회
...
1. 정회원은 봄학기와 가을학기마다 활동회원 또는 비활동회원에 속한다.
2. 정회원은 본인이 재학 중 정당한 사유로 본회 활동에 참여할 수 없으라 판단되는 경우 이사회에 비활동 신청 기간 동안 비활동 신청을 할 수 있다. 단, 해당 학기를 휴학하면 봄 정기총회 또는 가을 정기총회 전까지 이사회에 비활동 신청을 할 수 있다.
3. 비활동 신청 기간은 본원 학부 총학생회에 회원 명단을 제출하기 전으로 한다.
4. 이사회가 비활동 신청을 한 회원의 사유가 정당하다고 판단하면 다음 봄학기 또는 가을학기 개강일 전까지 해당 회원은 비활동회원이다.
...
2. 준회원은 해당 학기 동안 아래의 각호의 사항을 이행해야 하며, 이행하지 못할 시 개발자 또는 디자이너 자격심사에 참여하지 못하며 제12조에 따라 제명안에 상정된다.  
① 이사회에서 정한 회비 납부  
...
3. 회원이 다음 각호의 사유에 해당할 때 이사회에서 총회에 제명안을 상정할 수 있다.  
① 본회의 명예를 손상시키고 목적수행에 지장을 초래한 경우  
② 학부 졸업 시까지 명예 회원 승급이 이루어지지 않은 경우  
③ 기타 사유로 인해 이사회의 의결이 이루어진 경우  
4. 제명안이 상정된 회원이 총회에서 본회 활동을 지속할 것을 표명한 경우 소명 후 본인을 제외한 총회에 참석한 활동회원의 3분의 2 이상이 동의한 때에만 경고로 대체할 수 있다. 그 이외의 경우 제명된다.
...
3. 임원 후보의 선출은 자진 선출과 활동회원의 추천을 우선한다. 이때 후보가 없으면 이사회에서 임원 후보를 지명한다.
...
3. 감사는 일반회계 및 운영에 대해 감사하며 부정 또는 부당한 점이 있으면 이사회에 시정을 요구하고 그 보고를 위하여 이사회 또는 총회의 소집을 요구할 수 있다.
4. 회장을 제외한 이사는 다음 각호에 해당하는 직위를 총회 또는 이사회 의결을 통해 맡거나 직위를 해제할 수 있다.  
...
1. 회장은 본회를 대표하며, 총회와 이사회의 의장이 된다. 정기모임에서 사회자가 되거나 부회장을 사회자로 선임할 수 있다.
2. 회장은 본회의 대외활동에서 대표권을 가진다.
3. 회장은 임시총회와 이사회를 소집, 주관할 수 있다.
4. 회장은 회칙의 집행과 총회와 이사회에서 결정된 사항의 집행을 주관한다.
5. 회장은 신입회원 선발에 대해 최종 결정권을 가진다.

### 제19조 (부회장의 직무)

1. 부회장은 회장을 보좌하며, 회장의 부재 시 그 업무 및 권한을 대행한다.
2. 부회장은 회장의 요청으로 정기모임에서 사회자가 될 수 있다.
...
3. 총무는 정기모임, 워크숍 등 회원 전체가 참여하는 활동을 회원들에게 공지하는 것을 담당한다.
...
4. 예산 및 결산의 보고 및 승인
5. 이사회, 디자인 팀, 프로젝별 사업계획 및 활동의 보고 및 승인
6. 개발자 또는 디자이너 자격 심사
7. 제명안의 경고 대체
...
이사회와 총회의 의사 진행 경과와 결과는 회의록으로 작성해야 하며 의장과 참여 이사가 기명 날인한다.
...
6. PM은 프로젝트 운영에 있어서 중대한 사항 및 이사회가 요청한 사항을 바로 이사회에 보고해야 한다.

### 제31조 (정기모임)

1. 정규 학기 중 매주 1회 정기모임을 가진다. 단, 이사회의 결정으로 정기모임을 가지지 않을 수 있다.
2. 정기모임에서는 세미나와 프로젝트의 주제 및 계획을 주제 토론하며, 그 외 각종 본회의 전달 사항이나 활동을 논의한다.
...
4. Wheel 세미나는 Wheel 세칙에 따라 시행된다.
...
5. 제30조에 의하여 PM을 지명한다. 단 지명된 PM이 없으면 이사회는 프로젝트 구성원 중 한 명을 지목하거나 프로젝트를 해산할 수 있다.
...
3. 본조 1항의 협력이 예산 집행 및 편성, 기기의 사용성 등 본 회 운영에 현저한 영향을 주지 않는 경우 이사회의 판단 아래 PM이 본조 1항 및 2항의 의무와 권리를 대행할 수 있다. 단, 이 경우 이사회에 지속적인 보고의 의무를 진다.
4. 이사회는 외부 협력의 지속적인 증진을 위해서 1항의 협력에 관여하는 회원에게 성과급이나 특전을 줄 수 있다.
...
4. 예산 집행 시 모든 전표에 대해 영수증을 첨부하여야 한다.
...
2. 단, 이사회가 긴급하게 필요하다고 판단한 회칙 개정의 경우, 서면 의결을 진행할 수 있으며 서면 의결을 통해 의사를 표현한 회원은 물리적으로 총회 장소에 있지 않더라도 참석한 것으로 간주하여 참석 인원에 포함한다.
...
1. 본 회칙 전면 개정을 통한 본회의 창립 및 등기 등 모 과정은 본 회칙 시행 이전 임원들로 구성된 발기인들이 참여 및 수행한다.
2. 본 회칙 전면 개정 이전의 본회 회원은 본조 1항의 과정이 끝나는 즉시 이사회가 본회로 회원으로 등록한다.
3. 본조 1항에 따른 창립 시점부터 본조 2항에 따른 등록 사이에 기존 본회 회원들은 대한민국 법률적으로 등록되지 아니하였음에도 회원의 권리를 보장받고 의무를 이행하여야 한다.

### 제5조 (기존 세칙)

1. 본 회칙 시행 당시의 세칙은 본 회칙이 어긋나지 아니하는 모든 조항이 그 효력을 지속한다.
2. 본조 1항에서 어긋나는 조항에 대해서는 의사회 의결을 통해 세칙을 조속히 수정한다.
...
1. 정규학기의 개강일 이전까지 Wheel장에게 비활동 의사를 전달한 자는 비활동 Wheel로 인정되며 다음 학기 개강일 이전까지 Wheel의 의무를 가지지 않는다.
2. 비활동 Wheel이 아닌 Wheel은 활동 Wheel로 제4조에 따르는 의무를 진다.
...
6. Wheel이 아닌 회원들이 접근할 수 있는 서버를 결정한다.
...
3. 필요에 따라 여름학기 이외에 추가로 진행할 수 있다.
...
2. 디자인 팀의 대표자는 디자인 팀장이라 부른다. 디자인 팀장의 역할 및 선발 절차는 제8조의 내용을 따른다.
...
1. 디자인 팀의 회원 구성은 본회의 회칙에서 정한 바를 따른다. 활동회원으로 정의된 디자이너는 본회 회칙에 의거 정규 학기에 최소 1개 이상의 프로젝트에 참여해야 하며, 추가로 제5조에 따르는 활동을 수행할 의무를 진다.
...
1. 디자인 피드백은 디자이너가 독단적으로 작업하지 않으며, 타 디자이너들과의 협의를 통해 실제 출시될 프로젝트의 디자인 완성도를 끌어올리고 디자이너의 작업 부담을 줄이는 것을 목적으로 한다.
2. 디자인 피드백에서 디자이너는 디자인 피드백 당일까지의 작업 내용을 공개하고, 이에 대한 타 디자이너들의 의견을 듣는다.
3. 정규학기마다, 디자이너는 최소 1회 디자인 피드백을 받는다. 단, 디자인 팀장의 판단하에 최대 1회의 추가적인 디자인 피드백을 받을 의무가 있다.
4. 디자이너는 디자인 피드백의 내용을 선택적으로 수용할 권리가 있다.

### 제8조 디자인 팀장

1. 디자인 팀장은 디자인 팀의 전반적인 운영을 책임진다.
2. 디자인 팀장의 임기는 그를 임명한 총회의 다음 날로부터 차기 디자인 팀장을 임명하는 총회 당일까지의 1년이다.
3. 정기총회에서 디자이너의 자격을 가지는 1인을 전임 디자인 팀장이 결정한다. 단, 전체 디자인 팀 구성원 절반 이상의 동의를 얻어야 한다.
4. 디자인 팀장은 디자이너의 참여가 필요한 프로젝트를 판단하여 지정한다. 지정된 프로젝트는 출시 이전에 최소 한 번 이상 디자이너를 포함해야 한다.
...
4. 세미나의 구성 및 진행자는 디자인 팀장의 판단하에 제5조 3항의 개강 준비 모임에서 결정한다.
5. 신입 프로젝트의 진행 기간은 디자인 팀장의 판단하에 제5조 3항의 개강 준비 모임에서 결정한다.
6. 총회에서 본회 회원의 과반수의 동의를 얻은 자는 디자인 팀장의 승인 아래 디자이너의 자격을 얻는다.
7. 디자이너 프로그램을 수강하는 회원은 희망하는 경우 6조의 정기 세미나를 수강할 수 있으나 진행할 수는 없다.
